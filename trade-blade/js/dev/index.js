import { g as getHash, d as dataMediaQueries, s as slideDown, a as setHash, b as slideUp, c as slideToggle, e as bodyLockToggle, f as bodyLockStatus, h as getDigFormat, i as gotoBlock, u as uniqArray, j as bodyUnlock } from "./common.min.js";
(function polyfill() {
...
function initSliders() {
  if (document.querySelector(".swiper-deals")) {
    new Swiper(".swiper-deals", {
...
document.addEventListener("DOMContentLoaded", () => {
  const dropdowns = document.querySelectorAll(".period");
  dropdowns.forEach((dropdown) => {
    const btn = dropdown.querySelector(".period__btn");
    const list = dropdown.querySelector(".period__list");
    const label = dropdown.querySelector(".period__label");
